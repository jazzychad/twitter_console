...
abstract class Phirehose
{
  ...
  const URL_USERSTREAM_BASE = 'http://chirpstream.twitter.com/2b/';
  ...
  protected function connect() 
  {
    ...
    do {
      ...
      if ($this->method = METHOD_USERSTREAM) {
	$url = self::URL_USERSTREAM_BASE . 'user' . '.' . $this->format;
	echo "url is: " . $url;
      } else {
